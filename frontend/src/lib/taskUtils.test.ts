  ...
  const testcases: { args: Args; expected: Task[] }[] = [
    // 同一セクション内の移動
    {
      args: [
        [
          ...
          { sectionId: "SECTION_2", index: 0, id: "TASK_7", title: "task 7" },
    ...
    // 異なるセクション間の移動
    {
      ...
      expected: [
        ...
        { sectionId: "SECTION_1", index: 0, id: "TASK_1", title: "task 1" },
        { sectionId: "SECTION_1", index: 1, id: "TASK_3", title: "task 3" },
        { sectionId: "SECTION_1", index: 2, id: "TASK_5", title: "task 5" },
        { sectionId: "SECTION_1", index: 3, id: "TASK_6", title: "task 6" },
        { sectionId: "SECTION_2", index: 0, id: "TASK_7", title: "task 7" },
        { sectionId: "SECTION_2", index: 1, id: "TASK_8", title: "task 8" },
      ],
    },
    {
      ...
      expected: [
        ...
        { sectionId: "SECTION_1", index: 0, id: "TASK_6", title: "task 6" },
        { sectionId: "SECTION_2", index: 0, id: "TASK_1", title: "task 1" },
        { sectionId: "SECTION_2", index: 1, id: "TASK_5", title: "task 5" },
        { sectionId: "SECTION_2", index: 2, id: "TASK_7", title: "task 7" },
        { sectionId: "SECTION_2", index: 3, id: "TASK_8", title: "task 8" },
      ],
    },
    {
      args: [
